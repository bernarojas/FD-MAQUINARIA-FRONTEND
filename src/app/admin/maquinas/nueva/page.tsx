  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        <h1 className="text-2xl font-black text-slate-100 mb-8">Nuevo Equipo</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Ej: Termofusionadora PT 315 Tecnodue"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 text-slate-100 placeholder-slate-600 focus:outline-none focus:border-amber-500 transition-colors text-sm"
                  placeholder="Ej: Termofusión HDPE"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <label className="flex flex-col items-center justify-center border-2 border-dashed border-slate-700 hover:border-amber-500/50 rounded-xl p-8 cursor-pointer transition-colors group">
              <svg className="w-8 h-8 text-slate-600 group-hover:text-amber-500/60 transition-colors mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
