    ...
    <div className="min-h-screen pt-24 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <span className="text-amber-500 text-sm font-semibold tracking-widest uppercase">Contacto</span>
          <h1 className="mt-3 text-3xl md:text-4xl font-black text-slate-100">¿Necesita un Equipo?</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          {/* Formulario */}
          <Suspense fallback={<div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 h-96 animate-pulse" />}>
            <ContactForm />
          </Suspense>
          ...
          <div className="space-y-4">
            {[
              ...
              <a
                ...
                className="group flex items-center gap-5 bg-slate-900/60 hover:bg-slate-800/60 border border-slate-800 hover:border-amber-500/30 rounded-2xl px-6 py-5 transition-all"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-slate-500 font-semibold uppercase tracking-widest mb-0.5">{item.title}</p>
                  <p className="text-slate-200 text-sm font-medium truncate">{item.value}</p>
                </div>
                <span className="text-amber-500 text-sm font-semibold group-hover:text-amber-400 transition-colors shrink-0">
                  {item.cta} →
                </span>
              </a>
            ))}
